...
export function keyboardShortcutSetup() {
    ...
    addKeyboardShortcut( shortcuts.addSegment, () => insertSegment()                              );
    addKeyboardShortcut( shortcuts.addRating, () => insertRating()                                );
    addKeyboardShortcut( shortcuts.addDescription, () => insertDescription()                      );
